...
-- @param float positionZ z position
...
-- @param integer componentIndex index if component
...
-- @return boolean isOnField is on field
...
-- @return integer parentComponent id of parent component node
...
-- @param boolean useAttacherVehicleSpeed use speed of attacher vehicle
-- @return float lastSpeed last speed
...
-- @return boolean isFromVehicle is from vehicle
...
-- @param table component component
...
-- @param table display fill level information
...
-- @param integer jointDesc joint desc index
-- @param integer anchorActor anchor actor
...
-- @param integer axis axis
-- @param float minLimit min limit
-- @param float maxLimit max limit
...
-- @param table rootPosition root position (x, y, z)
-- @param integer i component index
-- @return boolean success success
...
-- @param integer xmlFile id of xml object
-- @param string key key
-- @param integer componentJointI component joint index
-- @param integer jointNode id of joint node
-- @param integer index1 index of component 1
-- @param integer index2 index of component 2
-- @return boolean success success
...
-- @param table component1 component 1
-- @param table component2 component 2
-- @param table jointDesc joint desc
-- @return boolean success success
...
function Vehicle:doCollisionMaskCheck(targetCollisionMask, path, node, str)
    ...
    if not ignoreCheck then
        ...
        if node == nil then
            for _, component in ipairs(self.components) do
                hasMask = hasMask or bitAND(getCollisionFilterMask(component.node), targetCollisionMask) == targetCollisionMask
            end
        else
            hasMask = hasMask or bitAND(getCollisionFilterMask(node), targetCollisionMask) == targetCollisionMask
        end
...
-- @return boolean doCheckSpeedLimit do check speed limit
...
-- @return string uppercaseFullName The uppercase full name of the vehicle.
...
-- @return string uniqueId This vehicle's unique id.
