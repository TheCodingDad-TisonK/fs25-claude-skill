...
-- @return list list of normalized values
...
-- @return list list of the 4 converted values as numbers: {red, green, blue, alpha}
...
-- @param str Attribute string containing exactly 4 numbers
-- @param defaultValue Default value to return if the "str" parameter value is nil or invalid for transformation.
-- @return list list of the 4 converted values as numbers: {red, green, blue, alpha}, or 16 numbers: 4x rgba.
...
-- @param defaultValue Default value to return if the "str" parameter value is nil or invalid for transformation.
-- @return list list of the UV coordinates as {u1, v1, u2, v2, u3, v3, u4, v4}
