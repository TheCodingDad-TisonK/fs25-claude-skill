...
---Adds a texture config file to the overlay manager. reads meta information like slices filename and resolution, and then reads information for all given slices, and saves them
-- @param string filename name of the texture config file, that contains all other data
-- @param string identifier for this texture config file, is used in front of slice id when creating overlays
...
-- @param string identifier format: "prefix.sliceId" first dot (.) is used as separator, creates overlay with data for slice with name sliceId in texture config file with name prefix
-- @param float? posX
-- @param float? posY
-- @param float? width
-- @param float? height
-- @param string? customEnv needed for mod support
-- @return Overlay? overlay Overlay instance or nil on error
...
-- @param string identifier format: "prefix.sliceId" first dot (.) is used as separator, creates overlay with data for slice with name sliceId in texture config file with name prefix
-- @param string? customEnv needed for mod support
-- @return table? slice slice table or nil on error
...
-- @param string configPrefix prefix that was used to add the texture config file to the overlay manager
-- @param string? customEnv needed for mod support
