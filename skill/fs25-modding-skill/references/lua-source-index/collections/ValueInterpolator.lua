...
---
-- @param any customKey custom key used for the updateable added to the mission
-- @param function get
-- @param function set
-- @param list target list of values to interpolate
-- @param float? duration
-- @param float? speed default: 1
-- @param table? customMt
-- @return ValueInterpolator? ValueInterpolator can be nil if validation check fails
