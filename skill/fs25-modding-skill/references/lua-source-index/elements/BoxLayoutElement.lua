...
-- @param boolean ignoreVisibility Visibility flag for element eligibility
...
-- @param integer offsetX additional offsets in x-direction, used for example in ScrollingLayouts, defaults to 0
-- @param integer offsetX additional offsets in y-direction, used for example in ScrollingLayouts, defaults to 0
