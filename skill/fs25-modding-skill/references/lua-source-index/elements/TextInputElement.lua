    ...
    if self.blockTime <= 0 and self:getIsActive() and self.forcePressed then
        ...
        if not isDown then
            ...
            if sym == Input.KEY_left then
                ...
                self:moveCursorLeft(bitAND(modifier, lctrlModifier) > 0)
                startSpecialKeyRepeating = true
                wasSpecialKey = true
            elseif sym == Input.KEY_right then
                -- is now handled by focus system
                self:moveCursorRight(bitAND(modifier, lctrlModifier) > 0)
                startSpecialKeyRepeating = true
                wasSpecialKey = true
            ...
            elseif sym == Input.KEY_backspace then
                ...
                if bitAND(modifier, lctrlModifier) > 0 then
            ...
            elseif sym == Input.KEY_return or sym == Input.KEY_KP_enter then
                ...
                wasSpecialKey = true
            elseif sym == Input.KEY_v and bitAND(modifier, lctrlModifier) > 0 then
